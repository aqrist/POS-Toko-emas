        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('gold-levels.store') }}" class="flex flex-col gap-4">
                        @csrf
                        ...
                        <div>
                            ...
                            <x-text-input id="percentage" name="percentage" type="number" step="0.01" class="mt-1 block w-full" value="{{ old('percentage') }}" required />
