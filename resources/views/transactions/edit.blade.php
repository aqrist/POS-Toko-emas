<x-app-layout>
    ...
    @php
        $items = old('items', $transaction->items->map(fn ($item) => [
        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('transactions.update', $transaction) }}" class="flex flex-col gap-6" id="transaction-form">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <x-text-input id="occurred_at" name="occurred_at" type="datetime-local" class="mt-1 block w-full" value="{{ old('occurred_at', $transaction->occurred_at->format('Y-m-d\TH:i')) }}" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="additional_fee" name="additional_fee" type="number" step="0.01" class="mt-1 block w-full" value="{{ old('additional_fee', $transaction->additional_fee) }}" />
                                <x-input-error class="mt-2" :messages="$errors->get('additional_fee')" />
                            </div>

                            <div>
                                <x-input-label for="notes" value="Catatan" />
                                <x-text-input id="notes" name="notes" type="text" class="mt-1 block w-full" value="{{ old('notes', $transaction->notes) }}" />
