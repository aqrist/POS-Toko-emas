<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can('viewAny', \App\Models\GoldLevel::class)
                        <x-nav-link :href="route('gold-levels.index')" :active="request()->routeIs('gold-levels.*')">
                            {{ __('Kadar') }}
                        </x-nav-link>
                    @endcan
                    @can('viewAny', \App\Models\GoldPrice::class)
                        <x-nav-link :href="route('gold-prices.index')" :active="request()->routeIs('gold-prices.*')">
                            {{ __('Harga') }}
                        </x-nav-link>
                    @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @endcan
            @can('viewAny', \App\Models\GoldLevel::class)
                <x-responsive-nav-link :href="route('gold-levels.index')" :active="request()->routeIs('gold-levels.*')">
                    {{ __('Kadar') }}
                </x-responsive-nav-link>
            @endcan
            @can('viewAny', \App\Models\GoldPrice::class)
                <x-responsive-nav-link :href="route('gold-prices.index')" :active="request()->routeIs('gold-prices.*')">
                    {{ __('Harga') }}
                </x-responsive-nav-link>
            @endcan
            @can('viewAny', \App\Models\Customer::class)
